...
# Drupal 7 - Install Profile Txprintco
...
Clone the project from [GitHub](https://github.com/Gizra/txprintco).
...
6. Makes a symlink within the /www/profiles directory to the /txprintco
   directory.
7. Run the Drupal installer (Drush) using the Txprintco profile.
